            ...
            <div class="space-y-4">
                ...
                <div>
                    <div class="flex items-center gap-2 mb-2">
                        <x-input-label name="ingredients" value="Ingrédients"
                ...
                <div>
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <button type="button"
                            class="inline-flex items-center justify-center w-6 h-6 text-sm font-medium text-blue-600 transition-colors bg-blue-100 rounded-full hover:bg-blue-200"
                            onclick="addPrice()">+</button>
                    </div>
                    <div id="pricesList" class="space-y-3">
                        @foreach ($product->variations as $index => $variation)
                            <div class="flex items-center gap-4 p-4 rounded-lg price-entry bg-gray-50">
                                <div class="flex-1">
                                    <x-input-label name="size" value="Taille"
                                        class="text-sm font-medium text-gray-700" />
                                ...
                                <div class="flex-1">
                                    <x-input-label name="price" value="Prix"
                                        class="text-sm font-medium text-gray-700" />
                                ...
                                <button type="button"
                                    class="self-end mb-2 text-gray-400 transition-colors hover:text-red-500"
